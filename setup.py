...
setup(
    ...
    # Landing page for KHULNASOFT's cybersecurity mission
    url="https://www.khulnasoft.com/cybersecurity",
    # Additional URLs for this project per
    # https://packaging.python.org/guides/distributing-packages-using-setuptools/#project-urls
    project_urls={
        "Source": "https://github.com/khulnasoft-lab/domain-manager-api",
        "Tracker": "https://github.com/khulnasoft-lab/domain-manager-api/issues",
    },
    # Author details
    author="Cybersecurity and Infrastructure Security Agency",
    author_email="github@khulnasoft.com",
